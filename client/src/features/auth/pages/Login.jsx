    ...
    <div className="auth">
      <div className="auth-card">
        <div style={{ textAlign: 'center', marginBottom: '1.5rem' }}>
          <div className="auth-brand-logo" style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: '48px', height: '48px', background: 'linear-gradient(135deg, #3b5c17, #29410f)', borderRadius: '14px', color: '#fff', marginBottom: '0.75rem', boxShadow: '0 8px 20px rgba(41, 65, 15, 0.25)' }}>
            <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round">
              <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" />
            </svg>
          </div>
          <h1 style={{ color: '#0F172A', marginTop: '0.25rem', fontSize: '1.75rem', fontWeight: 800 }}>Sign in to DropTalk</h1>
          <p className="muted" style={{ fontSize: '0.88rem', color: '#64748B', margin: '4px 0 0' }}>Welcome back! Enter your details to access your workspace.</p>
        </div>
