    ...
    <div className="auth">
      <div className="auth-card">
        <div style={{ textAlign: 'center', marginBottom: '1.5rem' }}>
          ...
          <h1 style={{ color: '#0F172A', marginTop: '0.25rem', fontSize: '1.75rem', fontWeight: 800 }}>Create your DropTalk Account</h1>
          <p className="muted" style={{ fontSize: '0.88rem', color: '#64748B', margin: '4px 0 0' }}>Join your team on DropTalk workspace messaging.</p>
        </div>
